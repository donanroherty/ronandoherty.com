...
Navigate to `http://localhost:8000/` in your browser and you should set the output of our `greet` function from `app.ts`.
...
Next we'll generate a `launch.json` file to tell VSCode to how launch a new instance of Chrome and attach to it.
